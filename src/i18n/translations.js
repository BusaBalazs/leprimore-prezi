export const translations = {
  hu: {
    nav: {
      concept: "Koncepció",
      locations: "Üzleti előnyök",
      seasonal: "Szezonalitás",
      business: "Megvalósítás",
      demo: "Demó",
      cta: "Kapcsolat",
    },
    ...
    concept: {
      ...
      features: [
        ...
        {
          icon: "crown",
          title: "A Le Primore világára szabva",
          body: "A történetek, feladatok és vizuális elemek a hotel arculatához, hangulatához, szolgáltatásaihoz és környezetéhez igazíthatók.",
        },
      ],
    },

    locations: {
      index: "02 / Üzleti előnyök",
      title: "Több mint szórakozás",
      body: "A program nemcsak elfoglaltságot kínál, hanem új lehetőséget teremt a hotel szolgáltatásainak bemutatására és a vendégek további aktivitásának ösztönzésére.",

      cards: [
        {
          title: "További szolgáltatások népszerűsítése",
          body: "A játék során megjelenő személyre szabott ajánlatok a wellness, gasztronómiai és egyéb hotel szolgáltatások felé terelhetik a vendégeket.",
        },
        {
    ...
    turnkey: {
      ...
      features: [
        ...
        },
        {
          ...
          body: "Gondoskodunk a tartalmak időszakos frissítéséről, a szezonális váltásokról és a későbbi továbbfejlesztésekről.",
        },
      ],
    },
    ...
    seasonal: {
      ...
      features: [
        {
          icon: "reset",
          title: "Frissíthető tartalom",
          body: "A történetek, feladatok és vizuális elemek az aktuális időszakhoz vagy eseményhez igazíthatók.",
        },
        {
          icon: "globe",
          title: "Többnyelvű",
          body: "Magyar és angol nyelven, igény esetén további nyelvekkel is elérhető.",
        },
      ],
    },
    ...
    business: {
      ...
      title: "Egyedi tartalom, teljes körű támogatás",

      cards: [
        {
          icon: "pen",
          title: "A hotelre szabva",
          lead: "Minden részlet a Le Primore világához igazítható.",
          body: "A program tartalma, története, vizuális megjelenése és feladatai egyaránt a hotel arculatához és vendégköréhez alakíthatók.",
        },
        {
          icon: "cloud",
          title: "Kulcsrakész megoldás",
          lead: "A technikai háttérrel sem kell foglalkoznia.",
          body: "A fejlesztéstől és hostingtól a frissítésekig a teljes digitális háttér kezelését a QRMB biztosítja.",
        },
      ],
    },
    ...
    demo: {
      ...
      features: [
        {
          icon: "check",
          title: "Két korosztály, kétféle kaland",
          body: "A demó egy mesés felfedezőutat mutat be a legfiatalabb vendégeknek, valamint egy történetközpontú rejtélyt az idősebb gyermekek, fiatalok és felnőttek számára.",
        },
      ],

      qrCaption: "Olvassa be a QR-kódot a telefonjával!",
      qrDescription: "Ha telefonon nézi a prezentációt, kattintson a gombra!",
      qrLink: "Játékok megnyitása",
    },
